...
import { ApiDetailSchema } from "../schema/api.js";
...
function parseRequestBody(operation) {
...
function parseResponses(operation) {
...
function parseParameters(pathItem, operation) {
...
export function indexSwagger(spec) {
    ...
    for (const [path, pathItemRaw] of Object.entries(paths)) {
        ...
        for (const method of HTTP_METHODS) {
            ...
            const operationId = typeof operationIdCandidate === "string" && operationIdCandidate.trim().length > 0
